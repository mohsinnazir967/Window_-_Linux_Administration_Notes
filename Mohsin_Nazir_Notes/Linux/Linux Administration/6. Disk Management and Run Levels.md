...
```
mkfs.xfs /dev/<logical_group>/<logical_volume> 
```

```
mkfs.xfs /dev/ubuntu_vg/ubuntu_lv 
```
...
```
logical volume mount /dev/<logical_group>/<logical_volume> /<directory>
```
```
logical volume mount /dev/ubuntu_vg/ubuntu_lv /ubuntu
```
    
2. And verify it by df -h